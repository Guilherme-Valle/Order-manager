...
public class Order_Controller {
    ...
    public Order_Controller (Orders_Screen view){
        ...
        listOfProducts.add(new Order(7, "Churros gelato morango", 8));
        listOfProducts.add(new Order(8, "Churros gelato creme", 8));
        listOfProducts.add(new Order(9, "Suco copo", 5));
        listOfProducts.add(new Order(10, "Suco garrafa", 12));
        listOfProducts.add(new Order(11, "Sorvete chocolate", 5));
        listOfProducts.add(new Order(12, "Sorvete creme", 5));
        listOfProducts.add(new Order(13, "Sorvete morango", 5));
        listOfProducts.add(new Order(14, "Milkshake chocolate", 8));
        listOfProducts.add(new Order(15, "Milkshake ovomaltine", 8));
        listOfProducts.add(new Order(16, "Milkshake morango", 8));
        listOfProducts.add(new Order(17, "Milkshake creme", 8));
